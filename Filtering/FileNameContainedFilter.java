...
/**
 * a contains filter, which is a name predicate for files, checks if a file name is contained in some other file name.
 *
 * @author rina.karnauch
 */
public class FileNameContainedFilter extends NamePredicate{
    ...
    /**
     * a constructor of the contains filter predicate
     *
     * @param fileName the name of the file holds the value to test to
     */
    public FileNameContainedFilter(String fileName) {
    ...
    public boolean test(File fileToFilter) {
        return fileToFilter.getName().contains(this.fileValue);
    }
}
